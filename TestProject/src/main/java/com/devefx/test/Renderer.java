...
//		gl.glViewport(0, 0, 400, 400);
		...
		gl.glTexCoord2f(0.0f, 1.0f); gl.glVertex3f(-0.5f,  0.5f,  1.0f); // ���Ͻ�
		gl.glTexCoord2f(1.0f, 1.0f); gl.glVertex3f( 0.5f,  0.5f,  1.0f); // ���Ͻ�
		...
		gl.glTexCoord2f(0.0f, 1.0f); gl.glVertex3f(-1.0f,  1.0f,  1.0f); // ���Ͻ�
		gl.glTexCoord2f(1.0f, 1.0f); gl.glVertex3f( 1.0f,  1.0f,  1.0f); // ���Ͻ�
