...
import com.devefx.edge.base.MatrixControl;
...
import com.devefx.edge.resources.Resources;
...
public class GLProgram {
	...
	public GLProgram() {
		...
		matrixControl = Director.getInstance().getMatrixControl();
		assert(matrixControl != null) : "matrixControl should not be null";
	}
	...
	public void setUniformsForBuiltins() {
		setUniformsForBuiltins(matrixControl.getMatrix(MatrixStackType.MATRIX_STACK_MODELVIEW));
	}
	
	public void setUniformsForBuiltins(Mat4 matrixMV) {
		Mat4 matrixP = matrixControl.getMatrix(MatrixStackType.MATRIX_STACK_PROJECTION);
		if(flag.usesP) {
